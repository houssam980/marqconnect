        ...
        {showAddSheet && (
          <>
            ...
            <motion.div
              ...
              style={{ bottom: '80px', maxHeight: '65vh' }}
            >
              ...
              <div className="px-4 space-y-3 overflow-y-auto" style={{ maxHeight: 'calc(65vh - 150px)' }}>
                <div>
        ...
        {showTaskDetail && selectedTask && (
          <>
            ...
            >
              ...
              <div className="px-4 space-y-4 overflow-y-auto" style={{ maxHeight: 'calc(70vh - 100px)' }}>
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">{selectedTask.title}</h3>
                  {selectedTask.tag && (
                    <p className="text-sm text-white/60">{selectedTask.tag}</p>
                  )}
                </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="text-sm text-white/70">Assigned Users</label>
                    {isAdmin && (
                      <button
                        onClick={() => {
                  ...
                  {selectedTask.assigned_users && selectedTask.assigned_users.length > 0 ? (
                    ...
                    <p className="text-sm text-white/50">No users assigned</p>
                  )}
                </div>
              </div>
            </motion.div>
        ...
        {showAssignSheet && taskToAssign && (
          <>
            ...
            <motion.div
              ...
              exit={{ y: '100%' }}
              transition={{ type: 'spring', damping: 25, stiffness: 300 }}
              className="fixed left-0 right-0 bg-[#1a1a1a] rounded-t-3xl z-[60]"
              style={{ bottom: '80px', maxHeight: '65vh' }}
            >
              <div className="flex justify-center pt-3 pb-2">
                <div className="w-10 h-1 bg-white/20 rounded-full" />
              ...
              <div className="px-4 space-y-2 overflow-y-auto" style={{ maxHeight: 'calc(65vh - 150px)' }}>
                {allUsers.map((u) => (
                  <button
                    key={u.id}
                    onClick={() => {
              ...
              <div className="p-4 mt-2">
                <button
                  ...
                  className="w-full py-3.5 bg-[#E1F700] text-black font-semibold rounded-xl disabled:opacity-50 active:scale-[0.98] transition-transform"
                >
                  {isAssigning ? 'Assigning...' : `Assign ${tempAssignees.length} User${tempAssignees.length !== 1 ? 's' : ''}`}
                </button>
              </div>
            </motion.div>
          </>
